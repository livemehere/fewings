...
declare const useQsState: <State extends Record<string, QsValue>>(initialState?: State, options?: Options) => readonly [State & Record<string, string | string[]>, (newState: SetStateAction<State>) => void];
```
